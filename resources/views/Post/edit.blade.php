            ...
            <form action="/post/{{$postDetail->id}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control"
                        value="@if(old('title')){{old('title')}}@else{{$postDetail->title}}@endif">
                    @if ($errors->has('title'))    
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" id="desc" class="form-control">@if(old('desc')){{old('desc')}}@else{{$postDetail->description}}@endif</textarea>
                    @if ($errors->has('desc'))
